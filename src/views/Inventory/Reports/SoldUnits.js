...
class SoldUnits extends React.PureComponent {
	constructor(props) {
		super(props);
					...
					<NavBar data={this.props} system="Inventory" history={this.props.history} logout={this.logOut}/>
						{
							...
							<div>
								...
								<Row className="page-header">
									<Col>
										<h4>Sold Units Report List<Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Add</Button> </h4>
									</Col>
								</Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(SoldUnits);
