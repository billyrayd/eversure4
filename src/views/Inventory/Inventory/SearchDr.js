...
class SearchDr extends React.PureComponent {
	constructor(props) {
		super(props);
	...
	componentDidMount(){
      ...
      "columns": [
          ...
          {title: "ACTION", createdCell: (td, cellData, rowData, row, col) => {
						ReactDOM.render(<div>
										<Button color="primary" size="sm" className="edit" style={{marginBottom: 5}}>
											Edit
										</Button> <br />
										<Button color="danger" size="sm" className="tba" style={{marginBottom: 5}}>
											TBA's
										</Button> <br />
										<Button color="warning" size="sm" className="clearance" style={{marginBottom: 5}}>
											Clearances
										</Button> <br />
										<Button color="success" size="sm" className="warranty" style={{marginBottom: 5}}>
											Warranty Claims
										</Button>
									</div>, td)
          }},
	...
	advancedFilter = () => {
		const dt_data = [
			[
				[],'fury', '4234234', '6346346', 'silay', '05/23/2020', '',
			],
			[
				[],'raider 115', '87987905', '6346346', 'talisay', '09/23/2020', '',
			],
			[
				[],'sniper 150', '34534006', '6346346', 'bacolod', '08/23/2020', '',
			]
		]
	...
	render() {
		...
		const currentPage = ["Search D.R. No.","/search_dr/"];
										...
										<Col>
											<Col className="advanced-filter">
												...
												<Row>
													...
													<Col md="4"><Button className="es-main-btn" color="primary" block>Add Invoice</Button> </Col>
												</Row>
												<div className="space" />
											</Col>
										</Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(SearchDr);
