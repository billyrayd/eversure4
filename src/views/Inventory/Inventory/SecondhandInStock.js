...
class SecondhandInStock extends React.PureComponent {
	constructor(props) {
		super(props);
	...
	render() {
		...
		const currentPage = ["Secondhand - In Stock","/secondhand_in_stock/"];
							...
							<div>
								...
								<Container className="with-subsidebar" fluid>
									...
									<Row className="page-header">
										<Col>
											<h4>Units in Stock <small>(Secondhand)</small> <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Add</Button> </h4>
										</Col>
									</Row>
									<Row>
										<Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(SecondhandInStock);
