...
class BrandnewCustomerRepossessed extends React.PureComponent {
	constructor(props) {
		super(props);
      ...
      "columns": [
          ...
          {title: "ACTION", createdCell: (td, cellData, rowData, row, col) => {
						ReactDOM.render(<div>
										...
										<Button color="success" size="sm" data-tip="Edit" className="edit">
											Transfer Unit
										</Button>
									</div>, td)
          }},
	...
	render() {
		...
		const currentPage = ["Brand New (Repossessed)","/brandnew_customer_repossessed/"];
		return (
			<div>
				...
				<div className="content">
					...
					<ConfirmDelete className="" modal={confirmDeleteShown} callBack={this.deleteFunction} closeModal={this.closeModal} />
					{
						permission ?
						<div>
							<CustomersSubSidebar subpage="/brandnew_customer_repossessed/" history={this.props.history} />
							<Container className="with-subsidebar" fluid>
								...
								<Row className="page-header">
									<Col>
										<h4>Customers with Repossessed Brand New Units <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Add</Button> </h4>
									</Col>
								</Row>
								<Row>
									<Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(BrandnewCustomerRepossessed);
