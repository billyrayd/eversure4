...
class SecondhandCustomerRepossessed extends React.PureComponent {
	constructor(props) {
		super(props);
			...
			<div>
				...
				<div className="content">
					...
					<ConfirmDelete className="" modal={confirmDeleteShown} callBack={this.deleteFunction} closeModal={this.closeModal} />
					{
						permission ?
						<div>
							<CustomersSubSidebar subpage="/secondhand_customer_repossessed/" history={this.props.history} />
							<Container className="with-subsidebar" fluid>
								...
								<Row className="page-header">
									<Col>
										<h4>Customers with Repossessed Secondhand Units <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Add</Button> </h4>
									</Col>
								</Row>
								<Row>
									<Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(SecondhandCustomerRepossessed);
