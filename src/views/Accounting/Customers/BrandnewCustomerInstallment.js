...
class BrandnewCustomerInstallment extends React.PureComponent {
	constructor(props) {
		super(props);
	...
	render() {
		...
		const currentPage = ["Brand New (Installment)","/brandnew_customer_installment/"];
			...
			<div>
				...
				<div className="content">
					...
					<ConfirmDelete className="" modal={confirmDeleteShown} callBack={this.deleteFunction} closeModal={this.closeModal} />
					{
						permission ?
						<div>
							<CustomersSubSidebar subpage="/brandnew_customer_installment/" history={this.props.history} />
							<Container className="with-subsidebar" fluid>
								...
								<Row className="page-header">
									<Col>
										<h4>Customers with Brand New Units <small>(Installment)</small> <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Add</Button> </h4>
									</Col>
								</Row>
								<Row>
									<Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(BrandnewCustomerInstallment);
