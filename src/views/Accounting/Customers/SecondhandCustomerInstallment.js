...
class SecondhandCustomerInstallment extends React.PureComponent {
	constructor(props) {
		super(props);
						...
						<div>
							...
							<Container className="with-subsidebar" fluid>
								...
								<Row className="page-header">
									<Col>
										<h4>Customers with Secondhand Units <small>(Installment)</small> <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Add</Button> </h4>
									</Col>
								</Row>
								<Row>
									<Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(SecondhandCustomerInstallment);
