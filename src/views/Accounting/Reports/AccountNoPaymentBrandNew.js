...
class ReportsAccountNoPaymentBrandNew extends React.PureComponent {
	constructor(props) {
		super(props);
			...
			<div>
				...
				<div className="content">
					...
					<ConfirmDelete className="" modal={confirmDeleteShown} callBack={this.deleteFunction} closeModal={this.closeModal} />
					{
						permission ?
						<div>
							<AccReportsSubSidebar subpage="/reports_account_no_payment_brandnew/" history={this.props.history} />
							<Container className="with-subsidebar" fluid>
								<Row className="page-header">
									<Col>
										<h4>Accounts without Payment Reports <small>(Customers with Brand New Units)</small> <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Create</Button> </h4>
									</Col>
								</Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportsAccountNoPaymentBrandNew);
