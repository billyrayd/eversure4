...
class ReportsTotalPaid extends React.PureComponent {
	constructor(props) {
		super(props);
			...
			<div>
				...
				<div className="content">
					...
					<ConfirmDelete className="" modal={confirmDeleteShown} callBack={this.deleteFunction} closeModal={this.closeModal} />
					{
						permission ?
						<div>
							<AccReportsSubSidebar subpage="/reports_total_paid/" history={this.props.history} />
							<Container className="with-subsidebar" fluid>
								<Row className="page-header">
									<Col>
										<h4>Total Paid Reports <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Create</Button> </h4>
									</Col>
								</Row>
