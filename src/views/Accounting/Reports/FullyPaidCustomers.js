...
class ReportsFullyPaidCustomers extends React.PureComponent {
	constructor(props) {
		super(props);
						...
						<div>
							...
							<Container className="with-subsidebar" fluid>
								<Row className="page-header">
									<Col>
										<h4>Fully Paid Customers Reports <Button className="es-main-btn" color="primary" size="sm"><FontAwesomeIcon className="font10" icon="plus" />  Create</Button> </h4>
									</Col>
								</Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportsFullyPaidCustomers);
